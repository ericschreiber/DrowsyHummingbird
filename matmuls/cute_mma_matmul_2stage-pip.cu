...
__global__ void kernelCutePipeline2Stage(
    ...
    // ----------------------------------------------------------------
    // 1. CTA COORDINATES (No Grid Swizzling)
    // ----------------------------------------------------------------
...
// HOST RUNNER
// -----------------------------------------------------------------------------
void runkernelCutePipeline2Stage(int M, int N, int K, bf16 *A, bf16 *B, bf16 *Out) {
    ...
    // Tiled Copies (Async) - CACHEALWAYS
...
using M1::runkernelCutePipeline2Stage;

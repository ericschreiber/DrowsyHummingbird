...
template <class ProblemShape,
          ...
          class CopyA,
          class CopyOut>
__global__ void kernelCuteSwizzle128BCopy(ProblemShape problem_shape, CtaTiler cta_tiler,
...
void runKernelCuteSwizzle128BCopy(int M, int K, bf16 *In, bf16 *Out) {
    ...
    TiledCopy copyA = make_tiled_copy(
        ...
        Layout<Shape<_1, _8>, Stride<_8, _1>>{}     // Each copies a full row of 64 bf16
    );
    ...
    kernelCuteSwizzle128BCopy<<<dimGrid, dimBlock, smem_bytes>>>(
...
using C4::runKernelCuteSwizzle128BCopy;
...
template <class ProblemShape,
          ...
          class SmemLayoutA,
          class CopyA>
__global__ void kernelCuteBasicCopy(ProblemShape problem_shape, CtaTiler cta_tiler,
    ...
    // Partition the tensors for the write back to global memory
...
void runKernelCuteBasicCopy(int M, int K, bf16 *In, bf16 *Out) {
...
using C0::runKernelCuteBasicCopy;